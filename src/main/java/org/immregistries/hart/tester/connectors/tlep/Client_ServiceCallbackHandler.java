...
public abstract class Client_ServiceCallbackHandler {
  ...
  public void receiveResultsubmitSingleMessage(
      org.immregistries.hart.tester.connectors.tlep.SubmitSingleMessageResponse result) {}
  ...
  public void receiveResultconnectivityTest(
      org.immregistries.hart.tester.connectors.tlep.ConnectivityTestResponse result) {}
