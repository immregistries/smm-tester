 ...
 * (05:33:49 IST)
 */
package org.immregistries.hart.tester.connectors.tlep;
...
public class Client_ServiceStub extends org.apache.axis2.client.Stub implements Client_Service {
   ...
   * 
   * @see org.immregistries.hart.tester.connectors.tlep.Client_Service#submitSingleMessage
   * @param submitSingleMessage4
   * 
   * @throws org.immregistries.hart.tester.connectors.tlep.UnknownFault_Message :
   * @throws org.immregistries.hart.tester.connectors.tlep.SecurityFault_Message :
   * @throws org.immregistries.hart.tester.connectors.tlep.MessageTooLargeFault_Message :
   */

  public org.immregistries.hart.tester.connectors.tlep.SubmitSingleMessageResponse submitSingleMessage(
      org.immregistries.hart.tester.connectors.tlep.SubmitSingleMessage submitSingleMessage4)
      throws java.rmi.RemoteException,
      org.immregistries.hart.tester.connectors.tlep.UnknownFault_Message,
      org.immregistries.hart.tester.connectors.tlep.SecurityFault_Message,
      org.immregistries.hart.tester.connectors.tlep.MessageTooLargeFault_Message {
    ...
    try {
      ...
      java.lang.Object object = fromOM(_returnEnv.getBody().getFirstElement(),
          org.immregistries.hart.tester.connectors.tlep.SubmitSingleMessageResponse.class,
          getEnvelopeNamespaces(_returnEnv));

      return (org.immregistries.hart.tester.connectors.tlep.SubmitSingleMessageResponse) object;
      ...
      if (faultElt != null) {
        if (faultExceptionNameMap.containsKey(
          ...
          try {
            ...
            if (ex instanceof org.immregistries.hart.tester.connectors.tlep.UnknownFault_Message) {
              throw (org.immregistries.hart.tester.connectors.tlep.UnknownFault_Message) ex;
            }

            if (ex instanceof org.immregistries.hart.tester.connectors.tlep.SecurityFault_Message) {
              throw (org.immregistries.hart.tester.connectors.tlep.SecurityFault_Message) ex;
            }

            if (ex instanceof org.immregistries.hart.tester.connectors.tlep.MessageTooLargeFault_Message) {
              throw (org.immregistries.hart.tester.connectors.tlep.MessageTooLargeFault_Message) ex;
            }
   ...
   * 
   * @see org.immregistries.hart.tester.connectors.tlep.Client_Service#startsubmitSingleMessage
   * @param submitSingleMessage4
   */
  public void startsubmitSingleMessage(
      ...
      final org.immregistries.hart.tester.connectors.tlep.Client_ServiceCallbackHandler callback)
      ...
      public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
        try {
          ...
          callback.receiveResultsubmitSingleMessage(
              (org.immregistries.hart.tester.connectors.tlep.SubmitSingleMessageResponse) object);
              ...
              try {
                ...
                if (ex instanceof org.immregistries.hart.tester.connectors.tlep.UnknownFault_Message) {
                  callback.receiveErrorsubmitSingleMessage(
                      (org.immregistries.hart.tester.connectors.tlep.UnknownFault_Message) ex);
                  return;
                }

                if (ex instanceof org.immregistries.hart.tester.connectors.tlep.SecurityFault_Message) {
                  callback.receiveErrorsubmitSingleMessage(
                      (org.immregistries.hart.tester.connectors.tlep.SecurityFault_Message) ex);
                  return;
                }

                if (ex instanceof org.immregistries.hart.tester.connectors.tlep.MessageTooLargeFault_Message) {
                  callback.receiveErrorsubmitSingleMessage(
                      (org.immregistries.hart.tester.connectors.tlep.MessageTooLargeFault_Message) ex);
                  return;
                }
   ...
   * 
   * @see org.immregistries.hart.tester.connectors.tlep.Client_Service#connectivityTest
   * @param connectivityTest6
   * 
   * @throws org.immregistries.hart.tester.connectors.tlep.UnsupportedOperationFault_Message :
   * @throws org.immregistries.hart.tester.connectors.tlep.UnknownFault_Message :
   */

  public org.immregistries.hart.tester.connectors.tlep.ConnectivityTestResponse connectivityTest(

      org.immregistries.hart.tester.connectors.tlep.ConnectivityTest connectivityTest6)

      throws java.rmi.RemoteException

      , org.immregistries.hart.tester.connectors.tlep.UnsupportedOperationFault_Message,
      org.immregistries.hart.tester.connectors.tlep.UnknownFault_Message {
    org.apache.axis2.context.MessageContext _messageContext = null;
    try {
      org.apache.axis2.client.OperationClient _operationClient =
      ...
      java.lang.Object object = fromOM(_returnEnv.getBody().getFirstElement(),
          org.immregistries.hart.tester.connectors.tlep.ConnectivityTestResponse.class,
          getEnvelopeNamespaces(_returnEnv));

      return (org.immregistries.hart.tester.connectors.tlep.ConnectivityTestResponse) object;
      ...
      if (faultElt != null) {
        if (faultExceptionNameMap.containsKey(
          ...
          try {
            ...
            if (ex instanceof org.immregistries.hart.tester.connectors.tlep.UnsupportedOperationFault_Message) {
              throw (org.immregistries.hart.tester.connectors.tlep.UnsupportedOperationFault_Message) ex;
            }
   ...
   * 
   * @see org.immregistries.hart.tester.connectors.tlep.Client_Service#startconnectivityTest
   * @param connectivityTest6
   */
      ...
      public void onMessage(org.apache.axis2.context.MessageContext resultContext) {
        try {
          ...
          callback.receiveResultconnectivityTest(
              (org.immregistries.hart.tester.connectors.tlep.ConnectivityTestResponse) object);
              ...
              try {
                ...
                if (ex instanceof org.immregistries.hart.tester.connectors.tlep.UnsupportedOperationFault_Message) {
                  callback.receiveErrorconnectivityTest(
                      (org.immregistries.hart.tester.connectors.tlep.UnsupportedOperationFault_Message) ex);
                  return;
                }
  ...
  private org.apache.axiom.om.OMElement toOM(
      org.immregistries.hart.tester.connectors.tlep.SubmitSingleMessage param,
      boolean optimizeContent) throws org.apache.axis2.AxisFault {

    try {
      return param.getOMElement(
          org.immregistries.hart.tester.connectors.tlep.SubmitSingleMessage.MY_QNAME,
  ...
  private org.apache.axiom.om.OMElement toOM(
      org.immregistries.hart.tester.connectors.tlep.SubmitSingleMessageResponse param,
      boolean optimizeContent) throws org.apache.axis2.AxisFault {

    try {
      return param.getOMElement(
          org.immregistries.hart.tester.connectors.tlep.SubmitSingleMessageResponse.MY_QNAME,
          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
    } catch (org.apache.axis2.databinding.ADBException e) {
      throw org.apache.axis2.AxisFault.makeFault(e);
    }
  ...
  private org.apache.axiom.om.OMElement toOM(
      org.immregistries.hart.tester.connectors.tlep.Fault param, boolean optimizeContent)
      throws org.apache.axis2.AxisFault {

    try {
      return param.getOMElement(org.immregistries.hart.tester.connectors.tlep.Fault.MY_QNAME,
          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
    } catch (org.apache.axis2.databinding.ADBException e) {
      throw org.apache.axis2.AxisFault.makeFault(e);
    }
  ...
  private org.apache.axiom.om.OMElement toOM(
      org.immregistries.hart.tester.connectors.tlep.SecurityFault param, boolean optimizeContent)
      throws org.apache.axis2.AxisFault {

    try {
      return param.getOMElement(org.immregistries.hart.tester.connectors.tlep.SecurityFault.MY_QNAME,
          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
    } catch (org.apache.axis2.databinding.ADBException e) {
      throw org.apache.axis2.AxisFault.makeFault(e);
    }
  ...
  private org.apache.axiom.om.OMElement toOM(
      org.immregistries.hart.tester.connectors.tlep.MessageTooLargeFault param,
      boolean optimizeContent) throws org.apache.axis2.AxisFault {

    try {
      return param.getOMElement(
          org.immregistries.hart.tester.connectors.tlep.MessageTooLargeFault.MY_QNAME,
          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
    } catch (org.apache.axis2.databinding.ADBException e) {
      throw org.apache.axis2.AxisFault.makeFault(e);
    }
  ...
  private org.apache.axiom.om.OMElement toOM(
      org.immregistries.hart.tester.connectors.tlep.ConnectivityTest param, boolean optimizeContent)
      throws org.apache.axis2.AxisFault {

    try {
      return param.getOMElement(
          org.immregistries.hart.tester.connectors.tlep.ConnectivityTest.MY_QNAME,
          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
    } catch (org.apache.axis2.databinding.ADBException e) {
      throw org.apache.axis2.AxisFault.makeFault(e);
    }
  ...
  private org.apache.axiom.om.OMElement toOM(
      org.immregistries.hart.tester.connectors.tlep.ConnectivityTestResponse param,
      boolean optimizeContent) throws org.apache.axis2.AxisFault {

    try {
      return param.getOMElement(
          org.immregistries.hart.tester.connectors.tlep.ConnectivityTestResponse.MY_QNAME,
          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
    } catch (org.apache.axis2.databinding.ADBException e) {
      throw org.apache.axis2.AxisFault.makeFault(e);
    }
  ...
  private org.apache.axiom.om.OMElement toOM(
      org.immregistries.hart.tester.connectors.tlep.UnsupportedOperationFault param,
      boolean optimizeContent) throws org.apache.axis2.AxisFault {

    try {
      return param.getOMElement(
          org.immregistries.hart.tester.connectors.tlep.UnsupportedOperationFault.MY_QNAME,
          org.apache.axiom.om.OMAbstractFactory.getOMFactory());
    } catch (org.apache.axis2.databinding.ADBException e) {
      throw org.apache.axis2.AxisFault.makeFault(e);
    }
  ...
  private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
    ...
    try {
      ...
      emptyEnvelope.getBody().addChild(param.getOMElement(
          org.immregistries.hart.tester.connectors.tlep.SubmitSingleMessage.MY_QNAME, factory));
  ...
  private org.apache.axiom.soap.SOAPEnvelope toEnvelope(org.apache.axiom.soap.SOAPFactory factory,
    ...
    try {
      ...
      org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
      emptyEnvelope.getBody().addChild(param.getOMElement(
          org.immregistries.hart.tester.connectors.tlep.ConnectivityTest.MY_QNAME, factory));
      return emptyEnvelope;
    } catch (org.apache.axis2.databinding.ADBException e) {
      throw org.apache.axis2.AxisFault.makeFault(e);
    }
  ...
  private java.lang.Object fromOM(org.apache.axiom.om.OMElement param, java.lang.Class type,
    ...
    try {
      ...
      if (org.immregistries.hart.tester.connectors.tlep.SubmitSingleMessage.class.equals(type)) {

        return org.immregistries.hart.tester.connectors.tlep.SubmitSingleMessage.Factory
            .parse(param.getXMLStreamReaderWithoutCaching());

      }

      if (org.immregistries.hart.tester.connectors.tlep.SubmitSingleMessageResponse.class
          .equals(type)) {

        return org.immregistries.hart.tester.connectors.tlep.SubmitSingleMessageResponse.Factory
            .parse(param.getXMLStreamReaderWithoutCaching());

      }

      if (org.immregistries.hart.tester.connectors.tlep.Fault.class.equals(type)) {

        return org.immregistries.hart.tester.connectors.tlep.Fault.Factory
            .parse(param.getXMLStreamReaderWithoutCaching());

      }

      if (org.immregistries.hart.tester.connectors.tlep.SecurityFault.class.equals(type)) {

        return org.immregistries.hart.tester.connectors.tlep.SecurityFault.Factory
            .parse(param.getXMLStreamReaderWithoutCaching());

      }

      if (org.immregistries.hart.tester.connectors.tlep.MessageTooLargeFault.class.equals(type)) {

        return org.immregistries.hart.tester.connectors.tlep.MessageTooLargeFault.Factory
            .parse(param.getXMLStreamReaderWithoutCaching());

      }

      if (org.immregistries.hart.tester.connectors.tlep.ConnectivityTest.class.equals(type)) {

        return org.immregistries.hart.tester.connectors.tlep.ConnectivityTest.Factory
            .parse(param.getXMLStreamReaderWithoutCaching());

      }

      if (org.immregistries.hart.tester.connectors.tlep.ConnectivityTestResponse.class
          .equals(type)) {

        return org.immregistries.hart.tester.connectors.tlep.ConnectivityTestResponse.Factory
            .parse(param.getXMLStreamReaderWithoutCaching());

      }

      if (org.immregistries.hart.tester.connectors.tlep.UnsupportedOperationFault.class
          .equals(type)) {

        return org.immregistries.hart.tester.connectors.tlep.UnsupportedOperationFault.Factory
            .parse(param.getXMLStreamReaderWithoutCaching());
