...
public class SecurityFault_Message extends java.lang.Exception {
  ...
  private org.immregistries.hart.tester.connectors.tlep.SecurityFault faultMessage;
  ...
  public void setFaultMessage(org.immregistries.hart.tester.connectors.tlep.SecurityFault msg) {
    faultMessage = msg;
  }

  public org.immregistries.hart.tester.connectors.tlep.SecurityFault getFaultMessage() {
    return faultMessage;
  }
}
