...
public class UnknownFault_Message extends java.lang.Exception {
  ...
  private org.immregistries.hart.tester.connectors.tlep.Fault faultMessage;
  ...
  public void setFaultMessage(org.immregistries.hart.tester.connectors.tlep.Fault msg) {
    faultMessage = msg;
  }

  public org.immregistries.hart.tester.connectors.tlep.Fault getFaultMessage() {
    return faultMessage;
  }
}
