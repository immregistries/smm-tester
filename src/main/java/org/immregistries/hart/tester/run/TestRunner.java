...
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_FORECAST_STATUS_INCLUDED;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_FORECAST_STATUS_NOT_INCLUDED;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_ERROR;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_ERROR_Z33;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_ERROR_Z33_QUERY_REJECTED;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_LIST;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_MATCH;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_MATCH_Z32;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_MATCH_Z42;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_MULTIPLE_Z31_Z33;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_NOT_FOUND;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_NOT_FOUND_OR_TOO_MANY;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_NOT_FOUND_Z33;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_PROFILE_ID_MISSING;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_PROFILE_ID_UNEXPECTED;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_TOO_MANY;
import static org.immregistries.org.immregistries.hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_UNEXPECTED_IIS_RESPONSE;
import java.util.ArrayList;
import java.util.List;
import java.util.Map;

import org.immregistries.org.immregistries.hart.RecordParameters;
...
import org.immregistries.hart.tester.manager.forecast.ForecastTesterManager;
import org.immregistries.hart.tester.manager.nist.ValidationReport;
import org.immregistries.hart.tester.manager.nist.ValidationResource;
import org.immregistries.hart.transform.TestCaseMessage;
import org.immregistries.hart.transform.TestError;
import org.immregistries.hart.transform.Transform;
import org.immregistries.hart.transform.Transformer;

import org.immregistries.hart.hl7ws.client.MessageValidationV2SoapClient;
...
public class TestRunner {
  ...
  private static synchronized ValidationReport validate(String message, ValidationResource validationResource) {
    MessageValidationV2SoapClient soapClient = new MessageValidationV2SoapClient(RecordParameters.EVS_URL);
