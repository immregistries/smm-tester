...
import static hart.RecordParameters.VALUE_RESULT_FORECAST_STATUS_INCLUDED;
import static hart.RecordParameters.VALUE_RESULT_FORECAST_STATUS_NOT_INCLUDED;
import static hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_ERROR;
import static hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_ERROR_Z33;
import static hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_ERROR_Z33_QUERY_REJECTED;
import static hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_LIST;
import static hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_MATCH;
import static hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_MATCH_Z32;
import static hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_MATCH_Z42;
import static hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_MULTIPLE_Z31_Z33;
import static hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_NOT_FOUND;
import static hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_NOT_FOUND_OR_TOO_MANY;
import static hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_NOT_FOUND_Z33;
import static hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_PROFILE_ID_MISSING;
import static hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_PROFILE_ID_UNEXPECTED;
import static hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_TOO_MANY;
import static hart.RecordParameters.VALUE_RESULT_QUERY_TYPE_UNEXPECTED_IIS_RESPONSE;
import java.util.ArrayList;
import java.util.List;
import java.util.Map;

import hart.RecordParameters;
